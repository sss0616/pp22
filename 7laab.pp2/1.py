...
mickey1 = pygame.image.load("clock.png").convert_alpha()
mickey = pygame.transform.scale(mickey1, (1050, 800))

hour_arm1 = pygame.image.load("rarm.png").convert_alpha()
...
minute_arm1 = pygame.image.load("larm.png").convert_alpha()
